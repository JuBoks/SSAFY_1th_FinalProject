...
public class YeonlipDealServiceImpl implements YeonlipDealService {
	...
	@Override
	public List<YeonlipDealDto> listYeonlipDeal(int yeonlipCode) {
		return yeonlipDealDao.listYeonlipDeal(yeonlipCode);
	}

	@Override
	public YeonlipDealDto search(Long no) {
		return yeonlipDealDao.search(no);
	}

	@Override
	public boolean insert(YeonlipDealDto yeonlipDealDto) {
		return yeonlipDealDao.insert(yeonlipDealDto) == 1;
	}

	@Override
	public boolean update(YeonlipDealDto yeonlipDealDto) {
